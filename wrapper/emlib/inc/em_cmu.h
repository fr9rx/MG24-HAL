...
#ifndef _CMU_HFRCOCTRL_BAND_1MHZ
#define _CMU_HFRCOCTRL_BAND_1MHZ 0
#endif
#ifndef _CMU_HFRCOCTRL_BAND_7MHZ
#define _CMU_HFRCOCTRL_BAND_7MHZ 0
#endif
#ifndef _CMU_HFRCOCTRL_BAND_11MHZ
#define _CMU_HFRCOCTRL_BAND_11MHZ 0
#endif
#ifndef _CMU_HFRCOCTRL_BAND_14MHZ
#define _CMU_HFRCOCTRL_BAND_14MHZ 0
#endif
#ifndef _CMU_HFRCOCTRL_BAND_21MHZ
#define _CMU_HFRCOCTRL_BAND_21MHZ 0
#endif
#ifndef _CMU_HFRCOCTRL_BAND_28MHZ
#define _CMU_HFRCOCTRL_BAND_28MHZ 0
#endif
#ifndef _CMU_HFPERCLKDIV_HFPERCLKEN_SHIFT
#define _CMU_HFPERCLKDIV_HFPERCLKEN_SHIFT 0
#endif
#ifndef _CMU_HFPERCLKEN0_GPIO_SHIFT
#define _CMU_HFPERCLKEN0_GPIO_SHIFT 0
#endif
#ifndef _CMU_HFCORECLKEN0_LE_SHIFT
#define _CMU_HFCORECLKEN0_LE_SHIFT 0
#endif
#ifndef CMU_LOCK_LOCKKEY_LOCK
#define CMU_LOCK_LOCKKEY_LOCK 0
#endif
#ifndef CMU_STATUS_CALBSY
#define CMU_STATUS_CALBSY 0
#endif
#ifndef CMU_CMD_CALSTART
#define CMU_CMD_CALSTART 0
#endif
...
typedef unsigned int CMU_ClkDiv_TypeDef;

/** High frequency RC bands. */
typedef enum
{
  /** 1MHz RC band. */
#if defined(_CMU_HFRCOCTRL_BAND_1MHZ)
  cmuHFRCOBand_1MHz  = _CMU_HFRCOCTRL_BAND_1MHZ,
#else
  cmuHFRCOBand_1MHz  = 0,
#endif
  /** 7MHz RC band. */
#if defined(_CMU_HFRCOCTRL_BAND_7MHZ)
  cmuHFRCOBand_7MHz  = _CMU_HFRCOCTRL_BAND_7MHZ,
#else
  cmuHFRCOBand_7MHz  = cmuHFRCOBand_1MHz,
#endif
  /** 11MHz RC band. */
#if defined(_CMU_HFRCOCTRL_BAND_11MHZ)
  cmuHFRCOBand_11MHz = _CMU_HFRCOCTRL_BAND_11MHZ,
#else
  cmuHFRCOBand_11MHz = cmuHFRCOBand_7MHz,
#endif
  /** 14MHz RC band. */
#if defined(_CMU_HFRCOCTRL_BAND_14MHZ)
  cmuHFRCOBand_14MHz = _CMU_HFRCOCTRL_BAND_14MHZ,
#else
  cmuHFRCOBand_14MHz = cmuHFRCOBand_11MHz,
#endif
  /** 21MHz RC band. */
#if defined(_CMU_HFRCOCTRL_BAND_21MHZ)
  cmuHFRCOBand_21MHz = _CMU_HFRCOCTRL_BAND_21MHZ,
#else
  cmuHFRCOBand_21MHz = cmuHFRCOBand_14MHz,
#endif
  /** 28MHz RC band. */
#if defined(_CMU_HFRCOCTRL_BAND_28MHZ)
  cmuHFRCOBand_28MHz = _CMU_HFRCOCTRL_BAND_28MHZ
#else
  cmuHFRCOBand_28MHz = cmuHFRCOBand_21MHz
#endif
...
unsigned int CMU_ClockFreqGet(CMU_Clock_TypeDef clock);
...
#endif
void CMU_HFRCOStartupDelaySet(unsigned int delay);
unsigned int CMU_HFRCOStartupDelayGet(void);

void CMU_OscillatorEnable(CMU_Osc_TypeDef osc, bool enable, bool wait);
unsigned int CMU_OscillatorTuningGet(CMU_Osc_TypeDef osc);
void CMU_OscillatorTuningSet(CMU_Osc_TypeDef osc, unsigned int val);

bool CMU_PCNTClockExternalGet(unsigned int inst);
void CMU_PCNTClockExternalSet(unsigned int inst, bool external);

unsigned int CMU_LCDClkFDIVGet(void);
void CMU_LCDClkFDIVSet(unsigned int div);

void CMU_FreezeEnable(bool enable);
unsigned int CMU_Calibrate(unsigned int HFCycles, CMU_Osc_TypeDef reference);
void CMU_CalibrateConfig(unsigned int downCycles, CMU_Osc_TypeDef downSel,
 ...
 ******************************************************************************/
__STATIC_INLINE void CMU_IntClear(unsigned int flags)
{
  (void)flags;
}
 ...
 ******************************************************************************/
__STATIC_INLINE void CMU_IntDisable(unsigned int flags)
{
  CMU->IEN &= ~flags;
}
 ...
 ******************************************************************************/
__STATIC_INLINE void CMU_IntEnable(unsigned int flags)
{
  CMU->IEN |= flags;
}
 ...
 ******************************************************************************/
__STATIC_INLINE unsigned int CMU_IntGet(void)
{
  return CMU->IF;
}
 ...
 *   (CMU_IF_nnn).
 ******************************************************************************/
__STATIC_INLINE unsigned int CMU_IntGetEnabled(void)
{
  uint32_t tmp = 0U;
 ...
 *****************************************************************************/
__STATIC_INLINE void CMU_IntSet(unsigned int flags)
{
  (void)flags;
}
